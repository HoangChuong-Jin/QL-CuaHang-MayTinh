                    ...
                    <div class="table-responsive-lg">
                        <table id="PhanTrang" class="table table-hover table-sm table-bordered">
							...
							<tr>
								...
								<td><a class="btn btn-warning" href='editDonHangAction?id=<s:property value="id"/>'><i class='fa fa-pencil-square-o text-white'></i></a></td>
								<td><a class="btn btn-danger" href='deleteDonHangAction?id=<s:property value="id"/>' onclick="return confirm('Bạn chắc chắn xóa?')"><i class="fa fa-trash"></i></a></td>
							</tr>
							</s:iterator>
						</table>
