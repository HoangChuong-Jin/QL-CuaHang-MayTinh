                	...
                	<s:form action="storeSanPhamAction" method="POST" enctype="multipart/form-data" validate="true">
					    <div class="form-row">
					    	<div class="form-group col-sm-12">
							    <s:textfield class="form-control" label="Tên sản phẩm" id="tenthuonghieu" name="tensanpham"  /> 
								<s:textfield class="form-control" id="mota" name="mota" label="Mô tả sản phẩm"  />
							</div>
							<div class="form-group col-sm-6">
								<s:textfield class="form-control" id="giagoc" name="giagoc" label="Giá gốc"  />
							</div>
							<div class="form-group col-sm-6">
								<s:textfield class="form-control" id="giaban" name="giaban" label="Giá bán"  />
							</div>
							<s:textfield class="form-control" id="soluongton" name="soluongton" label="Số lượng tồn"  />		
