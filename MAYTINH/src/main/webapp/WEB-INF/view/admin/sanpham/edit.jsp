    ...
    <div class="vertical-nav bg-white" id="sidebar">
      <div class="py-3 px-3 mb-4 text-white" style="background-color:rgb(26,148,255);">
        ...
        <ul class="nav flex-column mb-0">
            ...
            <li class="nav-item">
                <a href="listSanPhamAction" class="nav-link font-italic text-primary">
                	...
                	<s:form action="updateSanPhamAction" method="POST" enctype="multipart/form-data" validate="true">
						...
						<div class="form-row">
							<div class="form-group col-sm-6">
								<img width='300' src='./img/<s:property value="sanpham.hinhanh"/>'/><br/>
							</div>
							<div class="form-group col-sm-6">
								<s:textfield class="form-control" label="Tên sản phẩm" id="tensanpham" name="tensanpham" value="%{sanpham.tensanpham }"  /> 
								<s:textfield class="form-control" id="mota" name="mota" label="Mô tả" value="%{sanpham.mota }" />
								<s:textfield class="form-control" id="giagoc" name="giagoc" label="Giá gốc" value="%{sanpham.giagoc }" />
								<s:textfield class="form-control" id="giaban" name="giaban" label="Giá bán" value="%{sanpham.giaban }" />
								<s:textfield class="form-control" id="soluongton" name="soluongton" label="Số lượng tồn" value="%{sanpham.soluongton }" />		
								<s:file name="hinh" label="Chọn hình" accept="image/png, image/jpeg, image/gif"></s:file>
								
								<!--<s:textfield class="form-control" id="danhmuc" name="danhmuc" label="Danh mục" value="%{sanpham.danhmuc }" />-->
								
								<select class="form-control" name="danhmuc">
									<s:if test="sanpham.danhmuc=='Laptop'">
										<option value="Laptop" selected>Laptop</option>
								        <option value="Máy bàn">Máy bàn</option>
								        <option value="Khác">Khác</option>
									</s:if>
									<s:elseif test="sanpham.danhmuc=='Máy bàn'">
										<option value="Laptop">Laptop</option>
								        <option value="Máy bàn" selected>Máy bàn</option>
								        <option value="Khác">Khác</option>
									</s:elseif>
									<s:else>
										<option value="Laptop">Laptop</option>
								...
								<!--<s:textfield class="form-control" id="thuonghieu" name="thuonghieu" label="Thương hiệu" value="%{sanpham.thuonghieu }" />-->
								<select class="form-control" name="thuonghieu">
									<s:if test="sanpham.thuonghieu=='DELL'">
									...
									<s:elseif test="sanpham.thuonghieu=='HP'">
									...
									<s:elseif test="sanpham.thuonghieu=='Lenovo'">
								        <option value="DELL">Dell</option>
								        <option value="HP">HP</option>
									...
									<s:elseif test="sanpham.thuonghieu=='Asus'">
								        <option value="DELL">Dell</option>
								        <option value="HP">HP</option>
								        <option value="Lenovo">Lenovo</option>
									...
									<s:elseif test="sanpham.thuonghieu=='Aces'">
								        <option value="DELL">Dell</option>
								        <option value="HP">HP</option>
								        <option value="Lenovo">Lenovo</option>
								         <option value="Asus">Asus</option>
