    ...
    <div class="vertical-nav bg-white" id="sidebar">
      <div class="py-3 px-3 mb-4 text-white" style="background-color:rgb(26,148,255);">
        ...
        <ul class="nav flex-column mb-0">
            ...
            <li class="nav-item">
            <a href="listNguoiDungAction" class="nav-link text-primary font-italic">
            ...
            <div class="card">
                ...
                <div class="card-body">
                	<s:form action="updateNguoiDungAction" method="POST" enctype="multipart/form-data" validate="true">
						...
						<s:textfield class="form-control" label="Họ tên" id="hoten" name="hoten" value="%{nguoidung.hoten }" readonly="true" /> 
						<s:textfield class="form-control" id="sodienthoai" name="sodienthoai" label="Số điện thoại" value="%{nguoidung.sodienthoai }" readonly="true" />
						<s:textfield class="form-control" id="tendangnhap" name="tendangnhap" label="Tên đăng nhập" value="%{nguoidung.tendangnhap }" readonly="true" />
						
						<!--<s:textfield class="form-control" id="loaiquyen" name="loaiquyen" label="Loại quyền" value="%{nguoidung.loaiquyen }" />-->
						...
						<select class="form-control" name="loaiquyen">
							...
							<s:else>
								<option value="KHACH" selected>KHÁCH</option>
