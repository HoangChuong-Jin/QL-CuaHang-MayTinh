            ...
            <div class="card">
                ...
                <div class="card-body">
                	<s:form action="storeNguoiDungAction" method="POST" enctype="multipart/form-data" validate="true">
					    ...
					    <s:textfield class="form-control" label="Họ tên" id="hoten" name="hoten"  /> 
						<s:textfield class="form-control" id="sodienthoai" name="sodienthoai" label="Số điện thoại"  />
						<s:textfield class="form-control" id="tendangnhap" name="tendangnhap" label="Tên đăng nhập"  />
						<s:textfield class="form-control" id="matkhau" name="matkhau" label="Mật khẩu"  />
						
						<select class="form-control" id="loaiquyen" name="loaiquyen">
