                    ...
                    <form action="" method="GET">
                        <div class="form-row">
                            <div class="form-group col-sm-4">
                                <a href="createNguoiDungAction" class="btn btn-primary"><i class="fa fa-plus-square" ></i> Thêm mới</a>
                            </div>
                    ...
                    <div class="table-responsive-lg">
                        <table id="PhanTrang" class="table table-hover table-sm table-bordered">
							...
							<tr>
								...
								<td><a class="btn btn-warning" href='editNguoiDungAction?id=<s:property value="id"/>'><i class='fa fa-pencil-square-o text-white'></i></a></td>
								<td><a class="btn btn-danger" href='deleteNguoiDungAction?id=<s:property value="id"/>' onclick="return confirm('Bạn chắc chắn xóa?')"><i class="fa fa-trash"></i></a></td>
							</tr>
							</s:iterator>
